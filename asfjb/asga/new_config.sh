...
# 更新PanelType
echo "请选择PanelType: 1) SSpanel 2) NewV2board 3) V2board"
read panelTypeInput
...
# 更新NodeType
echo "请选择NodeType: 1) V2ray 2) Trojan 3) Shadowsocks 4) Shadowsocks-Plugin"
read nodeType
case $nodeType in
