    ...
    case "$num" in
        ...
        4)
            if [ ! -f /root/image/debian12.tar.gz ]; then
                curl -L https://hry99.live/api/v3/file/download/zePlkYOevEsQ9o0o?sign=Z7dDYkyS8-6hFfBAPFolx2sq7OihN8WD8LkdkCfnZ_U%3D%3A1714552946 -o /root/image/debian12.tar.gz
                echo "下载完成，开始导入镜像"
            fi
            cd /root >/dev/null 2>&1
